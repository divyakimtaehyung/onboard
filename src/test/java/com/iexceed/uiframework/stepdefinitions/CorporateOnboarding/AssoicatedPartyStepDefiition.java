...
public class AssoicatedPartyStepDefiition extends TestBase {
    ...
    @And("user fills new application with Associated party details (.+)$")
    public void user_fills_new_application_with_associated_party_details(String testcase) throws Exception {
