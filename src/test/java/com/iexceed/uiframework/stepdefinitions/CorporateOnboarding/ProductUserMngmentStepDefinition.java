...
import com.iexceed.uiframework.steps.CorporateOnboarding.ProductUsrMngPageActions;
...
public class ProductUserMngmentStepDefinition extends TestBase {
    ...
    @And("user fills new application with product and management details (.+)$")
    public void user_fills_new_application_with_product_and_management_details(String testcase) throws Exception {
    ...
    public void user_fills_product_selection_details(String testcase) throws Exception {
        ProductUsrMngPageActions productUsrMngPageActions=new ProductUsrMngPageActions();
        ...
        productUsrMngPageActions.SelectProduct(dataList.get("SalaryAccName"),dataList.get("PurposeOfAccount"),dataList.get("AdditionalDetails"),dataList.get("Curruncy"),dataList.get("TurnOver"),dataList.get("Country"),
                dataList.get("Income"),dataList.get("IncomeUSD"),dataList.get("OutGoing"),dataList.get("OutGoingUSD"));
        productUsrMngPageActions.ContinueCorpApplication();
    ...
    public void user_fills_adminstation_details(String testcase) throws Exception {
        ...
        Map<String, String> dataList = ExcelHandler.getTestDataInMap(props.getProperty("filePath"), props.getProperty("productselectSheet"), testcase);
        testdata.setTestDataInMap(dataList);
        productUsrMngPageActions.BankAdminUSerCreation(dataList.get("Title"), dataList.get("FirstName"), dataList.get("MidNAme"), dataList.get("LastName"), dataList.get("MobCode"), dataList.get("MobNum"), dataList.get("Email")
